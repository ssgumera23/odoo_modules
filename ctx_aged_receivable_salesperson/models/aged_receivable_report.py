    ...
    def _aged_partner_report_custom_engine_common(self, options, internal_type, current_groupby, next_groupby, offset=0, limit=None):
        ...
        def build_result_dict(report, query_res_lines):
            ...
            if current_groupby == 'id':
                ...
                sales_person_user = self.env['res.users'].browse(query_res['sales_person'][0]) if len(query_res['sales_person']) == 1 else None
                rslt.update({
                    ...
                    'sales_person': sales_person_user.name  if sales_person_user else None,
